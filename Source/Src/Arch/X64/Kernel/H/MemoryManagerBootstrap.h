/*
 * File Name: MemoryManagerBootstrap.h
 * File Version: 0.3.11
 * Author: OpenAI
...
void LosMemoryManagerSendAllocateFrames(const LOS_MEMORY_MANAGER_ALLOCATE_FRAMES_REQUEST *Request, LOS_MEMORY_MANAGER_ALLOCATE_FRAMES_RESULT *Result);
void LosMemoryManagerSendFreeFrames(const LOS_X64_FREE_FRAMES_REQUEST *Request, LOS_X64_FREE_FRAMES_RESULT *Result);
void LosMemoryManagerSendMapPages(const LOS_MEMORY_MANAGER_MAP_PAGES_REQUEST *Request, LOS_MEMORY_MANAGER_MAP_PAGES_RESULT *Result);
void LosMemoryManagerSendUnmapPages(const LOS_MEMORY_MANAGER_UNMAP_PAGES_REQUEST *Request, LOS_MEMORY_MANAGER_UNMAP_PAGES_RESULT *Result);
void LosMemoryManagerSendProtectPages(const LOS_MEMORY_MANAGER_PROTECT_PAGES_REQUEST *Request, LOS_MEMORY_MANAGER_PROTECT_PAGES_RESULT *Result);
void LosMemoryManagerSendQueryMapping(const LOS_MEMORY_MANAGER_QUERY_MAPPING_REQUEST *Request, LOS_MEMORY_MANAGER_QUERY_MAPPING_RESULT *Result);
